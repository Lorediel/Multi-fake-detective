...
class Model(nn.Module):
    def __init__(self):
        ...
        self.layer_norm2 = nn.BatchNorm1d(768)
...
class BertModel():
    ...
    def get_predictions(self, ds, tokenization_strategy, batch_size = 8):
    ...
    def train(self, train_ds, val_ds, lr = 5e-5, batch_size= 8, num_epochs = 3, warmup_steps = 0, save_path = "./", tokenization_strategy = "first", loss="cross_entropy"):
        device = "cuda:0" if torch.cuda.is_available() else "cpu"
        self.model.train()
        ...
        optimizer = AdamW(self.model.parameters(), lr=lr, weight_decay=0.001)
